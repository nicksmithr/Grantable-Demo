  ...
  <div>
    ...
    <div class="compare-container">
      <div class="compare-bottom">
        <div class="metrics">
          <h3><sup>1 MONTH REPORT</sup><br> COMPLETE</h3> |
          <h3><sup>6 MONTH REPORT</sup> <br>UPCOMING</h3> |
          <h3><sup>END-OF-GRANT REPORT</sup><br>DUE NOV. 2020</h3>
        </div>
      </div>
    </div>
    <div class="compare-container">
    ...
    <div class="bar-container">
      <bar-chart :title="'1 MONTH REPORT'" :data="$store.state.chartData" :value="agePotValue"></bar-chart>
    </div>
  </div>
  <div class="compare-panel report">
    <h3>1 MONTH REPORT</h3>
